...
test-cov:
	uv run pytest tests/ -v --cov=spartan --cov-report=term-missing --cov-report=html
...
lint:
	uv run ruff check spartan/ spartan_legacy/ tests/

lint-fix:
	uv run ruff check --fix spartan/ spartan_legacy/ tests/

format:
	uv run ruff format spartan/ spartan_legacy/ tests/

format-check:
	uv run ruff format --check spartan/ spartan_legacy/ tests/
...
# Run locally
run:
	uv run spartan --target example.com

# Run in debug mode
run-debug:
	uv run spartan --target example.com --debug

...
class localTaskCompleter(Completer):
    tasks: ClassVar[list[str]] = [
        "discuss",  # discuss with Spartan on the local task
        "brainstorm",  # let Spartan brainstorm on the local task
    ...
    task_meta: ClassVar[dict[str, HTML]] = {
        "discuss": HTML("Discuss with <b>Spartan</b> about this local task."),
        "brainstorm": HTML(
            "Let <b>Spartan</b> brainstorm on the local task for all the possible solutions."
        ),
...
Below are the available tasks:
    - discuss: Discuss with Spartan about this local task.
    - brainstorm: Let Spartan brainstorm on the local task for all the possible solutions.
    - help: Show the help page for this local task.
    - google: Search on Google.
...
class mainTaskCompleter(Completer):
    ...
    task_meta: ClassVar[dict[str, HTML]] = {
        ...
        "todo": HTML("Ask <b>Spartan</b> for todos."),
        "discuss": HTML("Discuss with <b>Spartan</b>."),
        "google": HTML("Search on Google."),
...
Below are the available tasks:
 ...
 - todo: Ask Spartan for the task list and what to do next.
 - discuss: Discuss with Spartan. You can ask for help, discuss the task, or give any feedbacks.

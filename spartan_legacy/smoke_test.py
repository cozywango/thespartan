...
non-zero if any *attempted* model fails, so this doubles as a CI/acceptance gate.
    ...
    spartan-legacy --smoke-test --provider anthropic
    spartan-legacy --smoke-test --model gpt-5.5
"""
...
from spartan_legacy.llm.registry import ALL_SPECS, PROVIDERS, ModelSpec

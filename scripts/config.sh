#!/usr/bin/env bash
# Spartan Authentication Configuration
...
EOF
        ...
        echo ""
        echo "  3. Run 'make connect' to start Spartan"
        ;;
...
echo -e "Run ${PURPLE}make connect${NC} to start Spartan."

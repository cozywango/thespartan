#!/usr/bin/env bash
# Spartan Container Entrypoint
# Sets up authentication based on SPARTAN_AUTH_MODE environment variable

set -e

AUTH_MODE="${SPARTAN_AUTH_MODE:-manual}"
...
echo ""
echo -e "${BLUE}=== Spartan Authentication ===${NC}"

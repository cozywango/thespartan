# Spartan Docker Image
# Lightweight penetration testing environment with Spartan

FROM ubuntu:24.04

LABEL description="Spartan - AI-Powered Penetration Testing Assistant"
LABEL version="1.0.0"
...
COPY --chown=pentester:pentester spartan/ /app/spartan/
...
# Users can run: spartan --target X
CMD ["/bin/bash"]

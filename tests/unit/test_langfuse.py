...
class TestLangfuseIntegration:
    ...
    def test_init_langfuse_disabled_via_flag(self):
        ...
        import spartan.core.langfuse as langfuse_module
    ...
    def test_get_or_create_user_id_creates_new(self):
        ...
        with (
            ...
            # File should exist
            user_id_file = Path(tmpdir) / ".spartan" / "user_id"
    ...
    def test_get_or_create_user_id_reads_existing(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            spartan_dir = Path(tmpdir) / ".spartan"
            spartan_dir.mkdir(parents=True)
            user_id_file = spartan_dir / "user_id"
    ...
    def test_tool_handler_creates_session_span_on_first_tool(self):
        ...
        assert call_kwargs["name"] == "spartan:10.10.11.234"

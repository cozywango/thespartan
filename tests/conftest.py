"""Shared pytest fixtures for Spartan tests."""
...
from spartan.core.backend import AgentBackend, AgentMessage
...
@pytest.fixture
def sample_config(temp_working_dir: Path) -> SpartanConfig:
